...
if(lnk == "home") {
    ...
    document.getElementById('divRight').innerHTML = "Home link clicked. Default text dislayed"
    document.getElementById('ls_Heading').innerHTML = "ITC-111";
    document.getElementById('rs_Heading').innerHTML = "<h4>Intro to Programming <br>w/HTML, CSS & JavaScript</h4>";
}else if (lnk == 'ce'){
